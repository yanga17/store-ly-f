...
import { ArrowDown, Eye, EyeOff, Pencil, Utensils } from 'lucide-react';
                        ...
                        <div className='flex items-center justify-center gap-6 w-[25%]'>
                            ...
                            </Link>
                            {
                                isExpanded === uid ?
                                    ...
                                    :
                                    <Eye size={30} strokeWidth={2} absoluteStrokeWidth color={colors[0]?.green} className={`lg:ease-in-out lg:duration-300`} onClick={() => toggleAccordion(Number(uid))} />
